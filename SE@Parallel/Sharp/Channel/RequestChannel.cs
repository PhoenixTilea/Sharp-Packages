...
namespace SE.Parallel.Processing
{
    ...
    /// </summary>
    public class RequestChannel<Ret> : ChannelBase
    {
        public RequestChannel(IDispatcher dispatcher)
            : base(dispatcher)
        { }
    ...
    /// A channel to obtain promise from pushed tasks
    /// </summary>
    public class RequestChannel<Ret, T0> : ChannelBase
    {
        public RequestChannel(IDispatcher dispatcher)
            : base(dispatcher)
        { }
    ...
    /// A channel to obtain promise from pushed tasks
    /// </summary>
    public class RequestChannel<Ret, T0, T1> : ChannelBase
    {
        public RequestChannel(IDispatcher dispatcher)
            : base(dispatcher)
        { }
    ...
    /// A channel to obtain promise from pushed tasks
    /// </summary>
    public class RequestChannel<Ret, T0, T1, T2> : ChannelBase
    {
        public RequestChannel(IDispatcher dispatcher)
            : base(dispatcher)
        { }
    ...
    /// A channel to obtain promise from pushed tasks
    /// </summary>
    public class RequestChannel<Ret, T0, T1, T2, T3> : ChannelBase
    {
        public RequestChannel(IDispatcher dispatcher)
            : base(dispatcher)
        { }
    ...
    /// A channel to obtain promise from pushed tasks
    /// </summary>
    public class RequestChannel<Ret, T0, T1, T2, T3, T4> : ChannelBase
    {
        public RequestChannel(IDispatcher dispatcher)
            : base(dispatcher)
        { }
    ...
    /// A channel to obtain promise from pushed tasks
    /// </summary>
    public class RequestChannel<Ret, T0, T1, T2, T3, T4, T5> : ChannelBase
    {
        public RequestChannel(IDispatcher dispatcher)
            : base(dispatcher)
        { }
    ...
    /// A channel to obtain promise from pushed tasks
    /// </summary>
    public class RequestChannel<Ret, T0, T1, T2, T3, T4, T5, T6> : ChannelBase
    {
        public RequestChannel(IDispatcher dispatcher)
            : base(dispatcher)
        { }
    ...
    /// A channel to obtain promise from pushed tasks
    /// </summary>
    public class RequestChannel<Ret, T0, T1, T2, T3, T4, T5, T6, T7> : ChannelBase
    {
        public RequestChannel(IDispatcher dispatcher)
            : base(dispatcher)
        { }
    ...
    /// A channel to obtain promise from pushed tasks
    /// </summary>
    public class RequestChannel<Ret, T0, T1, T2, T3, T4, T5, T6, T7, T8> : ChannelBase
    {
        public RequestChannel(IDispatcher dispatcher)
            : base(dispatcher)
        { }
    ...
    /// A channel to obtain promise from pushed tasks
    /// </summary>
    public class RequestChannel<Ret, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> : ChannelBase
    {
        public RequestChannel(IDispatcher dispatcher)
            : base(dispatcher)
        { }
